...
export const RESUME_DATA: ResumeData = {
    profile: {
        ...
        instagram: 'https://www.instagram.com/v.i.s.h.a.l._.26?igsh=cHY3ZW1ydmV0cjJs',
    ...
    experience: [
        ...
        },
        {
            ...
            details: [
                'Contributed to the development and optimization of fintech solutions, focusing on backend architecture and API integration to enhance platform scalability.',
                'Collaborated on implementing core features and debugging system-level issues to improve the overall user experience and application performance during the October–November 2025 tenure.'
            ]
        },
    ],
    education: [
